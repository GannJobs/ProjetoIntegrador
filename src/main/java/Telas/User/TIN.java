...
public class TIN extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Indicate error for correction");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String fed = this.jTextField1.getText();
        Feed feed = new Feed();
        feed.setFed(fed);
        FeedBO feedbo = new FeedBO();
        feedbo.incluirE(feed);
        this.jLabel2.setText("Success to submit");
