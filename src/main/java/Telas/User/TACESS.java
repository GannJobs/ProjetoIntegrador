...
public class TACESS extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.jTextField1 == null && this.jTextField2 == null){
            this.jLabel3.setText("Please, enter the login details!");
        }else{
            String user = this.jTextField1.getText();
            String pass = this.jTextField2.getText();
            LGBO lgbo = new LGBO();
            try {
                lgbo.verify(user, pass);
                if(TMenu.loginStatus == true){
                    this.jLabel3.setText("Login Done");
                }else{
