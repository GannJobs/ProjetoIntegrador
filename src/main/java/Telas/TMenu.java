...
import Telas.User.TFEED;
import Telas.User.THELP;
...
public class TMenu extends javax.swing.JFrame {
    ...
    public boolean LoginStatus(boolean LogStatus){
        if(LogStatus == true){
    ...
    private void initComponents() {
        ...
        jMenuItem3.setText("Registrarion");
        ...
        jMenuItem6.setText("Delete Data");
        ...
        jMenuItem7.setText("View Database");
        ...
        jMenuItem2.setText("View Feedback");
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        jPanel1.updateUI();
        jPanel1.add(tinc);
        tinc.setVisible(true);
        
    }//GEN-LAST:event_jMenuItem4ActionPerformed

    private void jMenu2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenu2ActionPerformed

        TUPDT tupdt = new TUPDT();
        jPanel1.removeAll();
        jPanel1.updateUI();
        jPanel1.add(tupdt);
        tupdt.setVisible(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        TraducaoBO trad = new TraducaoBO();
        Traducao tra = new Traducao();
        String trans;
        try {
            tra.setEg(eg);
            trans = trad.Translate();
            this.jLabel4.setText(trans);
        } catch (ClassNotFoundException ex) {
            ex.printStackTrace();
            this.label1.setText("Error");
