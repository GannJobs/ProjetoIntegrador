...
public class TINC extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the translation to be included");
    ...
    if(TMenu.loginStatus == true){
        if(this.jTextField1 == null && this.jTextField2 == null){
            this.jLabel4.setText("Please, enter the details!");
        }else{
        ...
        this.jLabel4.setText("login to access the tool");
    }
